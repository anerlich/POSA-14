...
public class DownloadActivity extends DownloadBase {
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	Intent intentDIS = DownloadIntentService.makeIntent(this, handler, getUrlString());
        	startService(intentDIS);
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	Intent intentTPDS = ThreadPoolDownloadService.makeIntent(this, handler, getUrlString());
        	startService(intentTPDS);
